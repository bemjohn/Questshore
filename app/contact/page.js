      ...
      <section className="relative bg-slate-900 py-16 md:py-24 text-center overflow-hidden">
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          ...
          <p className="text-slate-300 text-base md:text-xl max-w-2xl mx-auto font-light leading-relaxed px-4">
            Have questions about our port excursions or need help planning your
            time ashore? We are here to help you coordinate the perfect
            itinerary.
          </p>
        </div>
      </section>
        ...
        <div className="lg:col-span-5">
          ...
          <div className="space-y-6 border-t border-slate-100 pt-6">
            ...
            <div>
              ...
              <a
                href="mailto:hello@questashore.com"
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-slate-900 text-sm"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                <label className="text-xs font-semibold text-slate-700">
                  Cruise Ship &amp; Sail Date (Optional)
                </label>
                <input
                  type="text"
                  name="cruiseShip"
                  ...
                  onChange={handleChange}
                  placeholder="e.g., Celebrity Beyond - Oct 12"
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-slate-900 text-sm"
                />
              </div>
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea
                  ...
                  value={form.message}
                  onChange={handleChange}
                  placeholder="Tell us about your upcoming cruise plans or questions..."
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:outline-none focus:border-slate-900 text-sm resize-none"
                />
              </div>
              ...
              <button
                type="submit"
                className="w-full bg-slate-900 hover:bg-slate-800 text-white font-medium py-4 px-6 rounded-xl transition-colors duration-300 shadow-sm mt-4 text-sm tracking-wide cursor-pointer"
              >
                Send Message
              </button>
            </form>
